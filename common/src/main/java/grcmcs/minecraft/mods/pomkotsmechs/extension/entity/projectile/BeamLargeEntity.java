...
public class BeamLargeEntity extends PomkotsThrowableProjectile implements GeoEntity, GeoAnimatable {
    ...
    public BeamLargeEntity(EntityType<? extends ThrowableProjectile> entityType, Level level, LivingEntity shooter) {
        this(entityType, level, shooter, CombatBalance.BASE_DAMAGE_BEAM_LARGE);
    }

    public BeamLargeEntity(EntityType<? extends ThrowableProjectile> entityType, Level world, LivingEntity shooter, int damage) {
