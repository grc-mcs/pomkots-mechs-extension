...
public class Pmac01EntityRenderer extends GeoEntityRenderer<Pmac01Entity> {
    public Pmac01EntityRenderer(EntityRendererProvider.Context renderManager) {
        this(renderManager, new Pmac01EntityModel());
    }

    public Pmac01EntityRenderer(EntityRendererProvider.Context renderManager, Pmac01EntityModel model) {
        super(renderManager, model);
        addRenderLayer(new AutoGlowingGeoLayer<>(this));
    }

    @Override
    public void preApplyRenderLayers(PoseStack poseStack, Pmac01Entity animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
        this.scaleHeight = Pmac01Entity.DEFAULT_SCALE;
        this.scaleWidth = Pmac01Entity.DEFAULT_SCALE;
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, Pmac01Entity animatable, BakedGeoModel model, RenderType renderType,
        ...
        if (animatable.getDrivingPassenger() != null) {
            animatable.setClientSeatPos(getSeatPosition(model, animatable, Pmac01Entity.DEFAULT_SCALE));
