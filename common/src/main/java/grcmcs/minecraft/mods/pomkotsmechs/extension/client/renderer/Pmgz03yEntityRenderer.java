...
import grcmcs.minecraft.mods.pomkotsmechs.extension.client.model.Pmgz03yEntityModel;
...
public class Pmgz03yEntityRenderer extends GeoEntityRenderer<Pmgz03yEntity> {
    public Pmgz03yEntityRenderer(EntityRendererProvider.Context renderManager) {
        this(renderManager, new Pmgz03yEntityModel());
    }

    public Pmgz03yEntityRenderer(EntityRendererProvider.Context renderManager, Pmgz03yEntityModel model) {
        super(renderManager, model);
        addRenderLayer(new AutoGlowingGeoLayer<>(this));
    }

    @Override
    public void preApplyRenderLayers(PoseStack poseStack, Pmgz03yEntity animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, Pmgz03yEntity animatable, BakedGeoModel model, RenderType renderType,
