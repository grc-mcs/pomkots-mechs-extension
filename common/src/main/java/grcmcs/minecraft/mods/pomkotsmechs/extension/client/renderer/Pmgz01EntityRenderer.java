...
import grcmcs.minecraft.mods.pomkotsmechs.extension.client.model.Pmgz01EntityModel;
...
public class Pmgz01EntityRenderer extends GeoEntityRenderer<Pmgz01Entity> {
    public Pmgz01EntityRenderer(EntityRendererProvider.Context renderManager) {
        this(renderManager, new Pmgz01EntityModel());
    }

    public Pmgz01EntityRenderer(EntityRendererProvider.Context renderManager, Pmgz01EntityModel model) {
        super(renderManager, model);
        addRenderLayer(new AutoGlowingGeoLayer<>(this));
    }

    @Override
    public void preApplyRenderLayers(PoseStack poseStack, Pmgz01Entity animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, Pmgz01Entity animatable, BakedGeoModel model, RenderType renderType,
