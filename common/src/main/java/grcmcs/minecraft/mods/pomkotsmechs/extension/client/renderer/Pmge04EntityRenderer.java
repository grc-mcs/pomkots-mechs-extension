...
import grcmcs.minecraft.mods.pomkotsmechs.extension.client.model.Pmge04EntityModel;
...
public class Pmge04EntityRenderer extends GeoEntityRenderer<Pmge04Entity> {
    public Pmge04EntityRenderer(EntityRendererProvider.Context renderManager) {
        this(renderManager, new Pmge04EntityModel());
    }

    public Pmge04EntityRenderer(EntityRendererProvider.Context renderManager, Pmge04EntityModel model) {
        super(renderManager, model);
        addRenderLayer(new AutoGlowingGeoLayer<>(this));
    }

    @Override
    public void preApplyRenderLayers(PoseStack poseStack, Pmge04Entity animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, Pmge04Entity animatable, BakedGeoModel model, RenderType renderType,
